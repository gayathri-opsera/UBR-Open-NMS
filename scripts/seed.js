  ...
  if (await bcs.countDocuments() === 0) {
    await bcs.insertMany([
      ...
      },
      {
        ...
        latitude: 28.6139, longitude: 77.2095, azimuth: 270, rssi: -52,
  ...
  if (await devs.countDocuments() === 0) {
    const devices = [
      // ── BTS ──────────────────────────────────────────────────────────────
      {
        ...
        connectedIduSerials: ['SN-IDU-DN-001'],
        cascadedBtsSerials: [],
      ...
      },
      {
        ...
        connectedIduSerials: ['SN-IDU-MW-001'],
        cascadedBtsSerials: [],
      ...
      // ── CPE — Delhi North ─────────────────────────────────────────────────
      {
        ...
        latitude: 28.6210, longitude: 77.2110, elevation: 2.0, azimuth: null, tilt: null,
        connectedBtsSerial: 'SN-BTS-DN-001',
      ...
      },
      {
        ...
        latitude: 28.6230, longitude: 77.2080, elevation: 1.5, azimuth: null, tilt: null,
        connectedBtsSerial: 'SN-BTS-DN-001',
      ...
      },
      {
        ...
        latitude: 28.6190, longitude: 77.2140, elevation: 3.0, azimuth: null, tilt: null,
        connectedBtsSerial: 'SN-BTS-DN-001',
      ...
      // ── CPE — Delhi South ─────────────────────────────────────────────────
      {
        ...
        latitude: 28.5400, longitude: 77.3950, elevation: 1.0, azimuth: null, tilt: null,
      ...
      },
      {
        ...
        ipAddress: null, model: 'Senao EAP300',
        firmwareVersion: null, softwareVersion: null,
        status: 'PROVISIONING', uptimeSeconds: 0,
        latitude: 28.5380, longitude: 77.3920, elevation: 2.5, azimuth: null, tilt: null,
        connectedBtsSerial: 'SN-BTS-DS-001',
      ...
      // ── CPE — Mumbai West ─────────────────────────────────────────────────
      {
        ...
        latitude: 19.0810, longitude: 72.8820, elevation: 3.0, azimuth: null, tilt: null,
      ...
      },
      {
        ...
        latitude: 19.0740, longitude: 72.8750, elevation: 4.5, azimuth: null, tilt: null,
        connectedBtsSerial: 'SN-BTS-MW-001',
      ...
      },
      {
        ...
        latitude: 19.0790, longitude: 72.8800, elevation: 2.0, azimuth: null, tilt: null,
        connectedBtsSerial: 'SN-BTS-MW-001',
      ...
      // ── IDU ───────────────────────────────────────────────────────────────
      {
        ...
        latitude: 28.6139, longitude: 72.2095, elevation: 20.0, azimuth: 270, tilt: 0,
        connectedBtsSerial: 'SN-BTS-DN-001',
    ...
    console.log(`  ✓ devices: ${devices.length} inserted (3 BTS, 8 CPE, 3 IDU)`);
  }
}
  ...
  if (await alarms.countDocuments() === 0) {
    ...
    const docs = [
      // ── CRITICAL — ACTIVE ──
      {
        ...
        metricValue: null, threshold: null,
